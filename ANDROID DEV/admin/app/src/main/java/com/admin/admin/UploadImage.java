...
//1st
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("galley");
        storageReference = FirebaseStorage.getInstance().getReference().child("galley");

        pd = new ProgressDialog(this);

//2nd
        String[] items = new String[]{"Select Category", "Teacher day", "Holiday"};
